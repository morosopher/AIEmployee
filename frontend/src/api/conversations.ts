...
const parseConversation = (v: unknown): Conversation => { if (!v || typeof v !== 'object' || Array.isArray(v)) throw new Error('Invalid conversation'); const o = v as Record<string, unknown>; if (typeof o.id !== 'string' || typeof o.title !== 'string') throw new Error('Invalid conversation'); return o as Conversation }
